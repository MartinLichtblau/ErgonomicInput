...
; 
/**
+Misc: small things that are useful; e.g. em-dash   
*/
...
*$MButton Up::
	...
	If (A_PriorKey == "MButton" && A_PriorHotkey == "$MButton") {
...
*MButton Up::
	;Tooltip up
	Tooltip %A_TimeSincePriorKey% %A_TimeSinceHotkey% %A_PriorKey% %A_PriorHotkey% %A_ThisHotkey% %A_EndChar%
